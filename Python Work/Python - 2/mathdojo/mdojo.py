...
# PART II
# Modify MathDojo to take at least one integer(s) and/or list(s) as a parameter with any number of 
# values passed into the list. It should now be able to perform the following tasks:
